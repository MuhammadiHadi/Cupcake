...
class CountryCodeDialog {
    ...
    private static CountryCodeAdapter cca;
    private int defaultIndex = -1,selectedIndex = -1;
    ...
    openCountryCodeDialog(final CountryCodePicker codePicker, final String countryNameCode) {
        ...
        dialog = new BottomSheetDialog(context, R.style.Theme_CCP);
        ...
        View bottomSheet = LayoutInflater.from(context).inflate(R.layout.layout_picker_dialog, null);
        ...
        MaterialButton doneCCp = (MaterialButton) dialog.findViewById(R.id.done_ccp);
...
//            dialog.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE);
        ...
        cca = new CountryCodeAdapter(context, masterCountries, codePicker, rlQueryHolder, editText_search, textView_noResult, dialog, imgClearQuery,recyclerView_countryDialog);
